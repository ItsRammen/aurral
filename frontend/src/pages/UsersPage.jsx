...
export default function UsersPage() {
    ...
    return (
        <div className="page-container">
            <PageHeader
                title="User List"
                subtitle="Manage your local users and their access permissions."
                icon={Users}
                action={
                ...
                showModal && (
                    <div className="fixed inset-0 z-50 overflow-y-auto">
                        <div className="flex items-center justify-center min-h-screen p-4">
                            ...
                            ></div>
                            <div className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden animate-scale-in">
                                {/* Modal Header */}
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="p-8 pt-6 max-h-[60vh] overflow-y-auto">
                                        {activeModalTab === 'general' && (
                                            <div className="space-y-6 animate-fade-in">
                                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">General Settings</h4>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none transition-all ${editingUser?.authType === 'oidc' ? 'opacity-50 cursor-not-allowed' : ''}`}
                                        ...
                                        {activeModalTab === 'password' && (
                                            <div className="space-y-6 animate-fade-in">
                                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Security Settings</h4>
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-3 pl-10 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none transition-all"
                                                            placeholder="••••••••"
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="p-8 pt-4 bg-gray-100 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-800 flex gap-4">
                                        <button
                                            type="button"
                                            onClick={() => setShowModal(false)}
